...
test.describe('Front-end tests', () => {
  ...
  test('Create a client', async ({ page }) => {
    ...
    await page.fill('#app > div > div:nth-child(2) > div:nth-child(2) > input[type=email]', "Egzona.delija@gmail.se");
    await page.fill('#app > div > div:nth-child(2) > div:nth-child(3) > input[type=text]', "8744782646");
